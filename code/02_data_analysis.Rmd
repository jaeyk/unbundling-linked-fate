...
diff_progress_hurt <- df %>%
  ...
  summarize(
    ...
    boot.conf = ((MKinfer::boot.t.test(linked_progress, linked_hurt, R= 100)$boot.conf.int[2]) - MKinfer::boot.t.test(linked_progress, linked_hurt, R= 100)$boot.conf.int[1])/2
    )
...
ggsave("/home/jae/validating-two-linked-fates/outputs/diff_in_means_plot.png", width = 11)
