...
ggsave("/home/jae/validating-two-linked-fates/outputs/descriptive_stat_plot.png")
```
...
corr_plot <- function(data){data %>%
  ...
  ggplot(aes(x = Responses)) + geom_density() +  labs(y = "Density") + facet_wrap(~Measures)}
...
ggsave("/home/jae/validating-two-linked-fates/outputs/reliability_tests_plot.png", height = 8, width = 8)
...
ggsave("/home/jae/validating-two-linked-fates/outputs/diff_in_means_plot.png")
