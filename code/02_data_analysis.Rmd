...
The result from Tau equivalence test:

The robust F statistic is  67.467 
with a p-value  0 

The null hypothesis (the same true score for all items) is rejected. 

```{r}

# Tau equivalence test 

tau_result <- tau.test(df %>% dplyr::select(contains("linked")), varphi = 0.1)
...
## Prepapring the data for modeling 
