...
g1 <- draw_ggm(df, "Asians") + ggtitle("Asians")
g2 <- draw_ggm(df, "Blacks") + ggtitle("Blacks")
g3 <- draw_ggm(df, "Whites") + ggtitle("Whites")
g4 <- draw_ggm(df, "Latinx") + ggtitle("Latinx")
...
pearson_only <- bind_rows(
  mutate(fate_progress_ci, Type = "fate_progress"),
  mutate(fate_hurt_ci, Type = "fate_hurt"),
  mutate(progress_hurt_ci, Type = "progress_hurt")
)
...
ggsave(here("outputs", "pearson_with_cis.png"))
```
